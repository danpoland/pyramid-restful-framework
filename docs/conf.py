...
# -*- coding: utf-8 -*-
#
# Pyramid Restful Framework documentation build configuration file, created by
...
project = 'Pyramid Restful Framework'
copyright = '2018, Daniel Poland'
...
latex_documents = [
    (master_doc, 'PyramidRestfulFramework.tex', 'Pyramid Restful Framework Documentation',
